...
OutputData = table({'Ts';'delta_t_trim';'altitude_take_off_zone';'altitude_hold_zone';'theta_takeoff';...
    'k_d_phi';'k_d_theta';'k_i_beta';'k_i_chi';'k_i_V';'k_i_V2';'k_i_phi';'k_i_h';'k_p_beta';...
    'k_p_chi';'k_p_h';'k_p_phi';'k_p_theta';'k_p_V';'k_p_V2';'w_n_phi';'w_n_theta'},...
    [P.Ts;delta_t_trim;P.altitude_take_off_zone;P.altitude_hold_zone;P.theta_takeoff';...
    k_d_phi;k_d_theta;k_i_beta;k_i_chi;k_i_V;k_i_V2;k_i_phi;k_i_h;k_p_beta;...
    k_p_chi;k_p_h;k_p_phi;k_p_theta;k_p_V;k_p_V2;w_n_phi;w_n_theta]);

writetable(OutputData,'ParamsForPyAutopilot.csv','Delimiter',',','WriteVariableNames',0);
    
if count(py.sys.path,'') == 0
    insert(py.sys.path,int32(0),'');
end

P.MyAutopilot = py.autopilot.makeAutopilot();
